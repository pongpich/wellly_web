...
const Detail = () => {
  ...
  const { event, event_user, status_event_user } = useSelector(({ get }) =>
    get ? get : ""
  );
  ...
  console.log("status_event_user", status_event_user);
  ...
  const rewardScore = () => {
    ...
    return (
      <>
        ...
        {event_activity && event_activity.criteria_walk_step == "true" && (
          <>
            <div
        ...
        {event_activity && event_activity.criteria_distance == "true" && (
          <>
