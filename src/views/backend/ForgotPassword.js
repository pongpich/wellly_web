...
import style from "../../assets/css/ForgotPassword.module.css";
    ...
    <>
      ...
      >
        ...
        <Typography component="h1" variant="h5">
          <p className={style["event-creator"]}>ลืมรหัสผ่าน </p>
          <p className={style["forgot-password-text"]}>ติดต่อฝ่ายบุคคลบริษัทของคุณ  </p>
          <p className={style["forgot-password-text"]}>เพื่อทำการตั้งรหัสผ่านใหม่ </p>
        </Typography>
